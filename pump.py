...
while True:
    ...
    if localtime.tm_hour >= 8 and localtime.tm_hour < 21:
        pi.write(2, 0)  # lamps
    else:
        pi.write(2, 1)  # lamps
    if localtime.tm_sec < 30 and localtime.tm_min % 20 == 0 and (localtime.tm_hour >= 0 or localtime.tm_hour == 0):  # day and night
